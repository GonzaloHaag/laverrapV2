...
export const SectionCards = ({ totalIncomeByCurrentMonth, totalIncome, totalWashed, totalActiveClients, isLoading }: Props) => {
  return (
    <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      <CardPage title="Ingresos del mes" value={totalIncomeByCurrentMonth} Icon={DollarSignIcon} isLoading={isLoading} isMoney />
