...
import { ClientsPage, DashboardPage, EmployeesPage, LoginPage, ServicesPage, WashedPage } from "@/pages";
...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: PRIVATE_ROUTES.CLIENTS.name, Component: ClientsPage },
      { path: PRIVATE_ROUTES.WASHED.name, Component: WashedPage }
    ]
  },
  {
    path: "*",
